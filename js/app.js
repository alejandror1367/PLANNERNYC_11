...
function init() {
  ...
  // En esta subfase (7.3) la actualización es silenciosa: cuando hay
  // versión nueva, el SW toma control y la página recarga sola.
  // El banner "Nueva versión disponible" llega en la Fase 7.4.
  pwa.register();
