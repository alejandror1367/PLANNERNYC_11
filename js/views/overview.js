...
import * as intensityTimeline from '../components/intensityTimeline.js';
...
function template() {
  return `
    ...
    <div id="intensity-timeline-mount"></div>

    <div class="stat-row">
      <article class="stat-card">
        <p class="stat-card__label">Días totales</p>
        <p class="stat-card__num">13</p>
        <p class="stat-card__meta">3 oct → 15 oct</p>
      </article>
      <article class="stat-card">
        <p class="stat-card__label">NYC · Boston</p>
        <p class="stat-card__num"><span class="stat-card__accent">7</span><span class="stat-card__slash"> / </span>3</p>
        <p class="stat-card__meta">noches por ciudad</p>
      </article>
    </div>

    <article class="climate-card">
      <div class="climate-card__left">
        <p class="climate-card__label">Clima esperado</p>
        <p class="climate-card__temp">15–20°</p>
      </div>
      <p class="climate-card__note">otoño · ~7 días de lluvia</p>
      <span class="climate-card__dot" aria-hidden="true"></span>
    </article>

    <figure class="pull-quote">
      <span class="pull-quote__mark" aria-hidden="true">"</span>
      <blockquote class="pull-quote__text">Golden leaves. Bright lights. Good company.</blockquote>
      <figcaption class="pull-quote__cite">— Alejo &amp; Ana · Octubre 2026</figcaption>
    </figure>
    ...
    <div class="editorial-divider" role="separator" aria-hidden="true">
      <span class="editorial-divider__line"></span>
      <span class="editorial-divider__label">★ El viaje ★</span>
      <span class="editorial-divider__line"></span>
    </div>
    ...
    <div class="passport-stamp" aria-hidden="true">
      <span class="passport-stamp__inner">
        <span class="passport-stamp__top">★ TRAVEL DOSSIER ★</span>
        <span class="passport-stamp__big">NYC · BOS</span>
        <span class="passport-stamp__bottom">OCT 2026 · APPROVED</span>
      </span>
    </div>
  `;
}
...
export function mount() {
  ...
  // Montar timeline de intensidad (Fase 8.5)
  const timelineMount = $('#intensity-timeline-mount', panelEl);
  if (timelineMount) intensityTimeline.mount(timelineMount);
}
